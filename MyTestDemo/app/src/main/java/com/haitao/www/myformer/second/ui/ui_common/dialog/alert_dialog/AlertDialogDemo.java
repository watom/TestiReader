package com.haitao.www.myformer.second.ui.ui_common.dialog.alert_dialog;
...
import com.haitao.www.myformer.second.ui.ui_common.dialog.dialogUtils.DialogUtils;
    ...
    private void showListDialog() {
        ...
        listDialog.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                ToastUtils.showToast(AlertDialogDemo.this,
                        "Click: " + items[which]);
            }
        });
        listDialog.show();
