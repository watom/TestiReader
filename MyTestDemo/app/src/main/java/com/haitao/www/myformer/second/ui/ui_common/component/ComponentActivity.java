package com.haitao.www.myformer.second.ui.ui_common.component;
...
public class ComponentActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (Config.isTest) {
            ...
            Lout.e("ComponentActivity", "测试：点击后替换文字");
            label.setText("西安");
            Lout.e("ComponentActivity", "icon=" + itemAtPosition.get("icon") + "，name=" + itemAtPosition.get("label") + "，position=" + position + "，id=" + id);
        }
    }
}
