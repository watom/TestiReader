    ...
    public WebViewClient initWebViewClient(WebView webViewObj, String url){
        return new WebViewClient(){
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                Logout.d("wanghaitao010123==", "shouldOverrideUrlLoading");
                Logout.d("wanghaitao010123==", view.toString());
                Logout.d("wanghaitao010123==", request.getUrl());
                Logout.d("wanghaitao010123==", request.getRequestHeaders());
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                //设定加载开始的操作
                Logout.d("wanghaitao01011234==", "开始载入页面时调用此方法");
                Logout.d("wanghaitao01011234==", view.toString());
                Logout.d("wanghaitao01011234==", url);
                startLoading();
            }
            ...
            public void onLoadResource(WebView view, String url) {
                ...
                //设定加载资源的操作
                Logout.d("wanghaitao0101==", "在加载页面资源时会调用");
            }
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                Logout.d("wanghaitao0101==", "在页面加载结束时调用此方法");
                endLoading();
            }
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                Logout.d("wanghaitao0101==", "加载页面的服务器出现错误时");
            }
            ...
            public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
                ...
                Logout.d("wanghaitao0101==", "处理https请求");
