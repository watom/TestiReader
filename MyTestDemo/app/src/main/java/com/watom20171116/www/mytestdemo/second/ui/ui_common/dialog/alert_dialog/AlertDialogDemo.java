package com.watom20171116.www.mytestdemo.second.ui.ui_common.dialog.alert_dialog;
...
import com.watom20171116.www.mytestdemo.second.ui.ui_common.dialog.dialogUtils.DialogUtils;
...
public class AlertDialogDemo extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showNormalDialog() {
        ...
        dialog.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                MyToast.showToast(AlertDialogDemo.this, "确认");
            }
        });
        dialog.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MyToast.showToast(AlertDialogDemo.this, "取消");
            }
        });
        dialog.show();
    }
    ...
    private void showSpecialDialog() {
        ...
        dialog.setNeutralButton("选择1", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MyToast.showToast(AlertDialogDemo.this, "选择1");
            }
        });
        dialog.setNeutralButton("选择2", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MyToast.showToast(AlertDialogDemo.this, "选择2");
            }
        });
        dialog.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void showListDialog() {
        ...
        listDialog.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                MyToast.showToast(AlertDialogDemo.this,
                        "Click: " + items[which]);
            }
        });
        listDialog.show();
...
//        multiChoiceDialog.setMessage("我是一个多选+确认Dialog");
    ...
    private void showWaitingDialog() {
        ...
        final ProgressDialog waitingDialog =
                new ProgressDialog(AlertDialogDemo.this);
    ...
    private void showInputDialog() {
        ...
        inputDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MyToast.showToast(AlertDialogDemo.this,
                                "您输入的内容:  " + editText.getText().toString());
                    }
                }).show();
    }
    ...
    private void showCustomizeDialog() {
        AlertDialog.Builder customizeDialog =
                new AlertDialog.Builder(AlertDialogDemo.this);
        final View dialogView = LayoutInflater.from(AlertDialogDemo.this)
    ...
    private void showCustomTitleDialog() {
        AlertDialog.Builder customizeDialog =
                new AlertDialog.Builder(AlertDialogDemo.this);
        final View dialogTitleView = LayoutInflater.from(AlertDialogDemo.this)
    ...
    private void showOverrideListDialog() {
        ...
        listDialog.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MyToast.showToast(getApplicationContext(), "点击了" + items[which]);
            }
        });
        /**
        ...
        listDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            public void onDismiss(DialogInterface dialog) {
                MyToast.showToast(getApplicationContext(), "Dialog被销毁了");
            }
        });
        listDialog.show();
    }
    ...
    private void showfillCustomizeDialog() {
        ...
        View view = LayoutInflater.from(this).inflate(
                R.layout.popwindow_card_remind, null);
        dialog.show();
        ...
        btn_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                dialog.dismiss();
                MyToast.showToast(AlertDialogDemo.this, "退出完全自定义Dialog");
            }
        });
    }
    ...
    private void showDialogTool() {
        DialogUtils.getInstance().call(this, "我封装的Dialog", "标题", new DialogUtils.OnClickRightButtonListen() {
                ...
                , new DialogUtils.OnClickLeftButtonListen() {
                    @Override
                    public void onClick(Dialog dialog) {
                        MyToast.showToast(AlertDialogDemo.this, "您点击了取消");
                    }
                });
    }
