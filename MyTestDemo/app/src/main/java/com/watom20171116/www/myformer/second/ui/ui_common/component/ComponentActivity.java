package com.watom20171116.www.myformer.second.ui.ui_common.component;
...
import com.watom20171116.www.myformer.second.ui.ui_common.component.imageview.ImageViewCategory;
import com.watom20171116.www.myformer.second.ui.ui_common.component.textview.SpannableStringActivity;
import com.watom20171116.www.myformer.second.ui.ui_common.component.timepicker.DatePickerActivity;
import com.watom20171116.www.myformer.second.ui.ui_common.component.timepicker.TimePickerActivity;
...
public class ComponentActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (Config.isTest) {
            ...
            Logout.e("ComponentActivity", "测试：点击后替换文字");
            label.setText("西安");
            Logout.e("ComponentActivity", "icon=" + itemAtPosition.get("icon") + "，name=" + itemAtPosition.get("label") + "，position=" + position + "，id=" + id);
        }
    }
}
