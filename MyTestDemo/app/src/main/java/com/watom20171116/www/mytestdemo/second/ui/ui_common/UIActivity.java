package com.watom20171116.www.mytestdemo.second.ui.ui_common;
...
public class UIActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void initData(ListView view) {
        content = new String[]{"ListView", "Dialog", "Fragment","ViewPager", "AnimationActivity","Component","分页","侧边栏","UI模块测试","测量屏幕","Bitmap"};
