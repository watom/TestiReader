package com.watom20171116.www.mytestdemo.second.ui.ui_common.component.timepicker;
    ...
    private void datePicker01(int year, int monthOfYear, int dayOfMonth) {
        ...
        datePicker01.init(year, monthOfYear, dayOfMonth, new DatePicker.OnDateChangedListener() {
            ...
            public void onDateChanged(DatePicker datePicker, int year, int monthOfYear, int dayOfMonth) {
                MyToast.showToast(DatePickerActivity.this, "您选择的日期是：" + year + "年" + (monthOfYear + 1) + "月" + dayOfMonth + "日!");
