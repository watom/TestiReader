...
public class IReaderAdapter extends RecyclerView.Adapter<IReaderAdapter.ViewHolder> {
    private List<String> dataList;

    public IReaderAdapter(List<String> dataList) {
